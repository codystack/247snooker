                ...
                <main class="container-fluid px-3 py-5 p-lg-6 p-xxl-8">
                    <div class="mb-6 mb-xl-10">
                        <div class="row g-3 align-items-center">
                            <div class="col">
                                <h3 class="ls-tight">Withdrawals</h3>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="table-responsive mb-10 mt-5">
                                            <table id="admins" class="table table-hover table-striped table-sm table-nowrap">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $admin_id = 1;
                                                    $select_query = "SELECT * FROM withdrawal";
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center gap-3 ps-1">
                                                                        <div class="icon icon-shape w-rem-10 h-rem-10 rounded-circle text-sm bg-dark bg-opacity-10 text-dark"><i class="bi bi-bank2"></i></div>
                                                                        <div><span class="d-block text-heading fw-bold"><?php echo $amount; ?></span></div>
                                                                    </div>
                                                                </td>
                                                                <td><?php echo $accountInfo; ?></td>
