                ...
                <div class="card bg-white shadow">
                    <div class="card-body p-6">
                        <div class="mb-4 text-center">
                            ...
                            <h4 class="mt-2 mb-0">Registration Successful</h4>
                            <p class="text-dark fw-light fs-lg">Hello! <span class="fw-bold"><?php echo $_SESSION['firstName']; ?>,</span> welcome to the tribe, your registration was successful, login to complete registration. </p>
                            <a href="logout" type="button" class="btn btn-black">Login Account</a>
                        </div>
                    </div>
                </div>
            </div>
