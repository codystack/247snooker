                                    ...
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body">
                                            <div class="text-center">
                                                <img src="http://247snooker.com.ng/admin<?php echo $picture; ?>" class="rounded-circle avatar-xxl mb-3" alt="contestant" style="height: 13rem;width: 13rem;object-fit: cover;object-position: center;border-radius: 1rem;">
