                    ...
                    <div class="card-body p-6">
                        ...
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" autocomplete="off">
                            ...
                            <div class="form-floating mb-4">
                                <input type="text" id="firstName" class="form-control" name="firstName" placeholder="John" required>
                                <label for="firstName" class="form-label">First Name</label>
                            </div>

                            <div class="form-floating mb-4">
                                <input type="text" id="lastName" class="form-control" name="lastName" placeholder="Doe" required>
                                <label for="lastName" class="form-label">Last Name</label>
                            </div>

                            <div class="form-floating mb-4">
                                <input type="tel" id="phone" class="form-control" name="phone" placeholder="+23408162680095" required>
                            ...
                            <div>
                                <div class="d-grid">
                                    <button type="submit" class="btn btn-dark" name="register_btn">Sign in</button>
                                </div>
                            </div>
                            <div class="text-center mt-3">Already have an account? <a href="./" class="text-danger fw-bold">Sign in</a></div>
                        </form>
                    </div>
                </div>
            </div>
