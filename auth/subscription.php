					...
					<div class="card mb-4">
						...
						<div class="p-4 d-flex justify-content-between align-items-center">
							<div>
								...
								<span>Renew your subscription with ease.</span>
							</div>
                            <div class="nav btn-group flex-nowrap" role="tablist">
                                <a href="buy-subscription" class="btn btn-outline-primary btn-sm"> Subscribe</a>
                            </div>
						</div>
					</div>
                        ...
                        <div class="table-responsive card-body mt-4 mb-4">
                            ...
                            <table class="table mb-0" id="allTransactions">
                                ...
                                <tr>
                                    ...
                                    <th scope="col" class="border-0">Plan Code</th>
                                    <th scope="col" class="border-0">Plan</th>
                                    <th scope="col" class="border-0">Amount</th>
                                    <th scope="col" class="border-0">Date</th>
                                    <th scope="col" class="border-0 text-end">Status</th>
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    ...
                                    while($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        echo "<td class=\"align-middle border-top-0\">" .$voucherID. "</td>";
                                        ...
                                        echo "<td class=\"align-middle align-middle text-end border-top-0\">" ."<span class='badge badge-dot $class'></span><span class='$text text-capitalize'> $status </span>". "</td>";
