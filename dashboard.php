                    ...
                    <div class="col-lg-8 mx-auto">
                        <div class="card overflow-hidden bg-primary mb-5">
                            <div class="card-body inverted level-3">
                                <div class="row">
                                    <div class="col-lg-10">
                                        <span class="text-white eyebrow mb-2" id="greet"></span>
                                        <h2 class="mb-0">Welcome, <?php echo $_SESSION['firstName']; ?>!</h2>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="tab-pane fade show active" id="component-1-1" role="tabpanel"
                                        ...
                                        <div class="row g-3 g-xl-5">
                                            <div class="col-md-6" data-aos-delay="100">
                                                <a href="subscription" class="card equal-md-4-3 card-hover-border bg-white">
                                                    <div class="card-wrap text-center">
                                                        ...
                                                        <div class="card-footer pt-0 mt-auto">
                                                            <h4 class="card-title fw-light">My Subscription</h4>
                                                        </div>
                                                    </div>
                                                </a>
                                            </div>
                                            ...
                                            <div class="col-md-6" data-aos-delay="100">
                                                <a href="account" class="card equal-md-4-3 card-hover-border bg-white">
                                                    <div class="card-wrap text-center">
                                                        ...
                                                        <div class="card-footer pt-0 mt-auto">
                                                            <h4 class="card-title fw-light">My Account</h4>
                                                        </div>
                                                    </div>
                                                </a>
                                            </div>
